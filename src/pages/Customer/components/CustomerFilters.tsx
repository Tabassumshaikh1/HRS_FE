...
import { AccountType, AccountTypeLabel, ActivityStatus } from "../../../data/app.constant";
...
const CustomerFilters = ({ values, setFieldValue }: IProps) => {
  return (
    <div className="row">
      ...
      <div className="col-md-6 col-6">
        <FormControl fullWidth size="small">
          ...
          >
            ...
            <MenuItem value={AccountType.LOCAL}>{AccountTypeLabel.LOCAL}</MenuItem>
            <MenuItem value={AccountType.GOOGLE}>{AccountTypeLabel.GOOGLE}</MenuItem>
          </Select>
        </FormControl>
      </div>
